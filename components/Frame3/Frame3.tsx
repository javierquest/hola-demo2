...
import { Frame3Props } from 'types';
import { animated, useSpring, easings } from 'react-spring';

 
const Frame31: any = animated(styled("div")({  
...
const Frame5: any = animated(styled(Frame4)(({ theme }: any) =>({  
  width: `452px`,  
  height: `371px`,  
  position: `absolute`,  
  left: `57px`,  
...
function Frame3(props: Frame3Props): JSX.Element {
